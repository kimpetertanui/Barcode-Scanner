...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    public SearchAdapter(Context mContext, Activity mActivity, ArrayList<String> mItemList) {
    ...
    public SearchAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SearchAdapter.ViewHolder(view, viewType, mItemClickListener);
    }
    ...
    @Override
    public void onBindViewHolder(SearchAdapter.ViewHolder mainHolder, int position) {
