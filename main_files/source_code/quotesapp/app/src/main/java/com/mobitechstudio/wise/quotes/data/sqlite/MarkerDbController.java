package com.mobitechstudio.wise.quotes.data.sqlite;
...
public class MarkerDbController {

    private SQLiteDatabase db;

    public MarkerDbController(Context context) {
    ...
    public int insertData(String postDetails) {
        ...
        return (int) db.insert(
                DbConstants.MARKER_TABLE_NAME,
                DbConstants.COLUMN_NAME_NULLABLE,
                values);
    }

    public ArrayList<MarkerModel> getAllData() {
        ...
        Cursor c = db.query(
                DbConstants.MARKER_TABLE_NAME,  // The table name to query
    ...
    private ArrayList<MarkerModel> fetchData(Cursor c) {
        ArrayList<MarkerModel> favDataArray = new ArrayList<>();
        ...
        if (c != null) {
            if (c.moveToFirst()) {
                do {
                    ...
                    favDataArray.add(new MarkerModel(itemId, postDetails));
                } while (c.moveToNext());
            }
            c.close();
        }
    ...
    public void deleteEachMarker(String postDetails) {
